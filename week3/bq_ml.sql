CREATE OR REPLACE TABLE `de_zoomcamp.rides_ml` (
...
CREATE OR REPLACE MODEL `de_zoomcamp.tip_model`
OPTIONS
...
-- HYPER PARAM TUNNING
CREATE OR REPLACE MODEL `de_zoomcamp.tip_hyperparam_model`
OPTIONS
(model_type='linear_reg',
input_label_cols=['tip_amount'],
...
-- PREDICT THE HYPERPARAM MODEL
SELECT
*
FROM
ML.PREDICT(MODEL `de_zoomcamp.tip_hyperparam_model`,
(
SELECT
*
FROM
